...
router.get("/students", auth(UserRoles.INSTITUTE), instituteController.listInstituteStudents);
router.get("/reviews", auth(UserRoles.INSTITUTE), instituteController.listInstituteReviews);
router.get("/payments", auth(UserRoles.INSTITUTE), instituteController.listInstitutePayments);
