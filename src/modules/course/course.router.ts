...
// Mentor routes
router.get("/assigned/list", auth(UserRoles.MENTOR), courseController.getAssignedCourses);
router.get("/roster/:courseId", auth(UserRoles.MENTOR), courseController.getCourseRoster);

// Student routes
router.get("/enrolled/list", auth(UserRoles.STUDENT), courseController.getEnrolledCourses);
router.delete("/drop/:courseId", auth(UserRoles.STUDENT), courseController.dropCourse);
